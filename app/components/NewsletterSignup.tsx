  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto text-center">
        ...
        <p className="text-sm mb-6" style={{ color: "#6E6153" }}>
          Occasional tips on supplements and gut health. No spam, unsubscribe anytime.
        </p>

        {status === "submitted" ? (
          <p className="text-sm font-medium" style={{ color: "#C4744A" }}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
            ...
            <input
              ...
              className="flex-1 min-w-0 px-4 py-2.5 rounded-full border text-sm outline-none transition-colors focus:border-[#C4744A]"
              style={{ borderColor: "rgba(38,32,25,0.15)", color: "#262019" }}
            />
